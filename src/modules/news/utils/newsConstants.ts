...
/**
 * Types et constantes pour le module News
 * Migré depuis modules/news/components/news/constants.ts
 */
...
// Mis à jour avec les nouvelles clés i18n du module news
export const REPORT_REASONS: ReportReason[] = [
  { value: "spam", labelKey: "news.reportDialog.reasons.spam" },
  { value: "harassment", labelKey: "news.reportDialog.reasons.harassment" },
  { value: "hateSpeech", labelKey: "news.reportDialog.reasons.hateSpeech" },
  { value: "violence", labelKey: "news.reportDialog.reasons.violence" },
  { value: "inappropriate", labelKey: "news.reportDialog.reasons.inappropriate" },
  { value: "misinformation", labelKey: "news.reportDialog.reasons.misinformation" },
  { value: "other", labelKey: "news.reportDialog.reasons.other" },
];