...
export function CommentReactionsModal({ open, onOpenChange, voteCount, commentId }: CommentReactionsModalProps) {
  const t = useT("modules/profil");
  const [activeTab, setActiveTab] = useState<string>("all");
  const { data: voteData, isLoading } = useCommentVotes(open ? commentId : null);
