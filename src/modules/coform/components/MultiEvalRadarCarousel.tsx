 ...
 *
 * Recharts est lazy-chargé via `useClientModule` (~150kB) — le composant peut
 * être inclus dans n'importe quel bundle sans peser, le chart n'est résolu
 * qu'au mount côté client.
 */
