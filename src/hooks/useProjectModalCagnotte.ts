    ...
    queryFn: async () => {
      ...
      if (!answerId && projectModalId) {
        try {
          ...
          console.error('⚠️ Impossible de récupérer le projet complet via api.project:', projectFallbackError);
        }
      }
      ...
      try {
        ...
        console.error(`⚠️ Erreur lors de la récupération de l'answer ${answerId}:`, answerError);
      }
