 ...
 * rendu.
 *
 * INTÉRÊT : un `carrier.refresh()` réussi, d'où qu'il vienne (connexion, rechargement d'entité),
 ...
 * dernière reste une lecture PURE, appelable hors React — les deux doivent rester d'accord, cf. leurs
