...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // PAS d'animation de SORTIE (`data-[state=closed]:*`) : Radix `Presence` attend `animationend` avant
        // de démonter ; avec un contenu lourd qui re-render pendant la fermeture (@uiw/react-md-editor),
        // cet event ne se déclenche pas → le Dialog reste monté `state=closed` → son react-remove-scroll
        // laisse `<body>` verrouillé (`overflow:hidden` coincé, scroll perdu). Démontage immédiat = OK.
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Pas d'animation de SORTIE (cf. DialogOverlay) : évite le scroll-lock react-remove-scroll coincé
          // sur <body> quand un contenu lourd (éditeur markdown) empêche l'`animationend` de fermeture.
