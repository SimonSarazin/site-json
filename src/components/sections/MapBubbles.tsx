            ...
            <div className="relative z-10 container mx-auto max-w-4xl">
                <div className="relative w-full @container/map-bubbles">
                        ...
                        {props.items.map((item, index) => (
                            ...
                            >
                                ...
                                <span
                                    ...
                                    className=" z-[1] font-serif -mt-5 mr-0 whitespace-nowrap rounded-full bg-[oklch(0.20_0.03_265)] px-2 py-0.5 text-white shadow-md md:absolute md:right-1/3 md:top-1/2 md:-mt-0 md:mr-2 md:-translate-y-1/2 top-1/2  text-xl"
                    ...
                    {/* `top`/`mb` réduits sur mobile : sur une carte étroite, le badge (à taille
                        ...
                        sûr ici. */}
                    <div className="absolute top-0 xs:top-0 sm:top-0 md:top-16 right-10 z-20 flex flex-col items-end gap-1 sm:gap-2 text-right ">
                        ...
                        {props.subhead && (
                            ...
                            <p className={`max-w-32 sm:max-w-50 text-[0.65rem] text-lg md:max-w-60 md:text-lg text-left translate-x-2 sm:translate-x-0 ${overlay ? "text-white/90" : "text-muted-foreground"}`}>
                                {t(props.subhead)}
                            </p>
                        )}
                    </div>
