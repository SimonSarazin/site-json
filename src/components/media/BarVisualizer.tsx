/**
 * Adapté de ElevenLabs UI (https://github.com/elevenlabs/ui, MIT) — registry/elevenlabs-ui/ui.
 * Web Audio API natif, sans dépendance externe. Usage: visualisation/enregistrement audio (Paroles de parents).
 */
/* eslint-disable react-refresh/only-export-components, react-hooks/exhaustive-deps, react-hooks/set-state-in-effect, react-hooks/preserve-manual-memoization -- code VENDORÉ ElevenLabs UI : patterns audio (rAF/AudioContext) conservés tels quels, hors conventions React-Compiler du repo. */
"use client"
