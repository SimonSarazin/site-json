            ...
            <nav className="container mx-auto py-4">
                <div className="flex items-center justify-between">
                    ...
                    {header.utilities?.auth && (
                        <ClientOnly fallback={<div className="hidden md:flex items-center space-x-4 text-sm"><Button variant="ghost" disabled size="sm">…</Button></div>}>
                            {() => (
                                <div className="hidden md:flex items-center space-x-4 text-sm">
                                    {me?.isConnected ? (
                                        <>
                                            <DropdownMenu>
                                                <DropdownMenuTrigger asChild>
                                                    <button className="bg-gray-100 rounded-full px-4 py-1.5 flex items-center gap-2 hover:bg-gray-200 transition">
                                                        <div className="font-medium rounded-full px-2 py-1 bg-white text-gray-700 text-xs">
                                            ...
                                            <button className="text-gray-700 hover:text-teal-500 transition" onClick={() => navigate('/settings')}>
                                                <Settings className="w-5 h-5" />
                                            </button>
                                            <button className="text-gray-700 hover:text-teal-500 transition" onClick={() => navigate(getProfileUrl())}>
                                        ...
                                        <button
                                            className="bg-gray-100 rounded-full px-4 py-1.5 flex items-center gap-2 hover:bg-gray-200 transition font-medium text-gray-700"
