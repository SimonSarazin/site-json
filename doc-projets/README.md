...
| Ekilib.re — Maison Sport Santé du Tampon | `associationEkilibre` | [maison-sport-sante-la-tampon.md](maison-sport-sante-la-tampon.md) | Sous-site territorial du costum SSBE (CP 97430/97418). Vitrine + annuaires créneaux/structures ✅ (11 pages, audit 0 constat). **Lot création/modif de créneaux codé mais non commité** ; `npm install` post-merge, contact cassé (`/api/contact`), recette et déploiement à faire |
