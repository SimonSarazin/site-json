...
export function LoginForm() {
  // Charge à la volée les JSON de traduction sous /modules/auth/i18n
...
* **`useLoadNamespace("modules/auth")`** :
  ...
  * Charge `src/modules/auth/i18n/fr.json` et `en.json` via un import dynamique.
