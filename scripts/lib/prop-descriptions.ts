...
export const PROP_DESCRIPTIONS: Record<string, Record<string, string>> = {
  ...
  profiles: {
    ...
    "default.editModalMatch": "Condition {clé: valeur} sur serverData qui gate editModal : AND implicite, égalité stricte ou .includes() si array ; non satisfaite → modal générique.",
    "default.editModals": "Table de routage multi sous-types : le PREMIER élément dont editModalMatch matche gagne → placer le catch-all (sans match) EN DERNIER ; sinon repli editModal, puis edit-profile.",
